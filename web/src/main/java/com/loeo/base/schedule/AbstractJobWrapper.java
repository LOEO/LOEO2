...
import com.chuanghai.easypm.webapp.baseservice.schedule.core.factory.JobDetailFactory;
import com.chuanghai.easypm.webapp.baseservice.schedule.core.factory.JobExecutingInfoFactory;
import com.chuanghai.easypm.webapp.baseservice.schedule.core.jobs.info.JobExecutingInfo;
...
public abstract class AbstractJobWrapper implements JobWrapper {
	...
	public JobDetail getJobDetail() {
		if (jobDetail == null) {
			...
			jobDataMap.putIfAbsent(JobWrapper.JOB_DATA_MAP_KEY_JOB_WRAPPER, this);
		}
		return jobDetail;
	}
